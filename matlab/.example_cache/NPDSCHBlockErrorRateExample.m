...
% * The variable |NPDSCHModulation| indicates the modulation scheme used by
% the NPDSCH. The allowed values of |NPDSCHModulation| are |'QPSK'| and
% |'16QAM'|.
% * The number of NPDSCH repetitions and the transport block size (TBS) are
% affected by whether NPDSCH is carrying SIB1-NB or not and the modulation
% scheme used by NPDSCH (see 3GPP TS 36.213 16.4.1.3 and 16.4.1.5 [ <#19 2>
% ]). |NPDSCHDataType| set to |'SIB1NB'| indicates that the NPDSCH is
% carrying SIB1-NB; |NPDSCHDataType| set to either |'BCCHNotSIB1NB'| or
...
NPDSCHDataType = 'NotBCCH';  % The allowed values are 'SIB1NB', 'BCCHNotSIB1NB' and 'NotBCCH'
NPDSCHModulation = 'QPSK'; % The allowed values are 'QPSK' and '16QAM'
...
for repIdx = 1:numel(ireps)
    ...
    npdschInfo.ISF = ISF;
    npdschInfo.OperationMode = enb.OperationMode;
    npdschInfo.Modulation = NPDSCHModulation;
    ...
    npdsch.Modulation = NPDSCHModulation;
    npdsch.RNTI = 1;
